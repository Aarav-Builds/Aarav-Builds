...
<img src="https://raw.githubusercontent.com/Aarav-Builds/Aarav-Builds/CareerJourney/journey.svg" width="100%" alt="Aarav's career journey timeline" />
...
| :-- | :-- | :-- |
| **Oracle Fusion Cloud ERP Process Essentials** `1Z0-1160-1` | Oracle | End-to-end ERP flows across Financials, Project & Risk Management |
| **Develop & Automate with SAP Build** | SAP | Low-code app development & workflow automation on SAP BTP |
| **Bloomberg Market Concepts (BMC)** | Bloomberg | FX, fixed income, equities & Bloomberg Terminal navigation |
| **Machine Learning Basics** | ACENET Canada | Supervised & unsupervised learning, regression and classification with scikit-learn |
